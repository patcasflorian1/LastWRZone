...
<!-- NavBar -->
  ...
  <div class="col-lg-12 grid-margin stretch-card">
                   <div class="card">
       <div class="card-body">
<h4 style="color:red;">Lista Registre de Casa  <c:out value="${mesage}"></c:out></h4>
...
<tbody>
<c:forEach var="chas" items="${chasRegisters}">
<tr>
<td><c:out value="${chas.id}"></c:out></td>
<td>
<a class="button badge badge-success"  
  title="WievRegister"  href="viewregister.htm?id=${chas.id}" id="view-source"
             ><c:out value="${chas.month}"></c:out></a>
</td>
<td><c:out value="${chas.year}"></c:out></td>
<td><c:out value="${chas.operator }"></c:out></td>
<td>
<a class=" button badge badge-danger" data-toggle="modal" data-id="${chas.id}"
                            title="DeleteChasReg"  href="#DeleteChasReg" id="view-source" >
