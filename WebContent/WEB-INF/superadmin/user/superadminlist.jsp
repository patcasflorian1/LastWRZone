...
<th>Statut</th>
<th>
<a href="#AddUser"  class="badge badge-success" title="AddNewUser" data-toggle="modal" data-id="${userList}" id="view-source"  >
            <i class="fa fa-plus"></i>Add NewUser</a>
</th>
</tr>
</thead>
<tbody>
...
<td><c:out value="${user.statute}"></c:out></td>
<td>
 <a class="button badge badge-success" data-toggle="modal" data-id="${user.id}"
                           data-id1= "${user.fullName}" data-id2= "${user.phoneNumber}"
                           data-id3= "${user.email}" data-id4= "${user.role}"
                           data-id5= "${user.statute}"
                            title="EditUser"  href="#EditUser" id="view-source" >
                              <i class="fas fa-pencil-alt">
                              EditUser
                               </i>
                          </a>
   <a class="button badge badge-success" 
    href="<c:url value="userlocation.htm?id=${user.id}"></c:url>" >
                              <i class="fas fa-pencil-alt">
                              ListaLocatiiUser
                               </i>
                          </a>                        
                          <a class=" button badge badge-danger" data-toggle="modal" data-id="${user.id}"
                           data-id1= "${user.fullName}" title="DeleteUser"  href="#DeleteProduct" id="view-source" >
