...
<td ><a class="button badge badge-success" href ="<c:url value='admin-view-location.htm?id=${loc.id}'/>"><c:out value="${loc.locationName}"></c:out></a></td>
</c:if>
<c:if test="${ loc.isLogin =='OffLine'}">
<td ><a class="button badge badge-danger" href ="<c:url value='admin-view-location.htm?id=${loc.id}'/>"><c:out value="${loc.locationName}"></c:out></a></td>
</c:if>
