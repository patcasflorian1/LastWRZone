...
<!-- NavBar -->
  ...
  <form action="createlocationlistadmin.htm" method="post" > 
 <p><input type="hidden"  name="idUser" id="idUser" value="<c:out value="${user.id}"></c:out>"/></p>
 <p style="color:red">Selectati din lista, Salile utilizatorului :<c:out value="${user.fullName}" ></c:out></p>
                   <div class="card">
                   <table class="fixed_header">
                      ...
                      <c:forEach var= "loc" items="${locationList}">
                        <tr>                         
                          <td><input type="hidden"  name="id" id="id" value="<c:out value="${loc.id}"></c:out>"/><c:out value="${loc.id}"></c:out></td>  
                          <td>
                          <input type="hidden"  name="idLocationList" id="idLocationList" value="<c:out value="${loc.id}"></c:out>"/>
                           <label for="locationName"><c:out value="${loc.locationName}"></c:out></label> 	                     
                          <input type="checkbox"  name="locationName" id="locationName" value="<c:out value="${loc.locationName}"></c:out>"/>												
                          </td>                     
                        </tr>
                         </c:forEach>          
                      </tbody>
     ...
     <table class="fixed_header">
                      ...
                      <tr>
                      <td>
                      <p style="color:blue"> Salile utilizatorului :<c:out value="${user.fullName}" ></c:out></p>
                      </td>
                      </tr>
                        <tr>
                          <th >Id</th>
                      ...
                      <tbody>                     
                      <c:forEach var= "loc" items="${finalUserLocList}">
                        <tr>                         
                          <td><c:out value="${loc.id}"></c:out></td>  
                          <td>	                     
                          <c:out value="${loc.locName}"></c:out>												
                          </td>                     
                        </tr>
                         </c:forEach>          
                      </tbody>
