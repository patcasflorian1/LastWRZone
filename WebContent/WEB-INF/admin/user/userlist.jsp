              ...
              <div class="collapse" id="ui-basic">
                  <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="<c:url value="admin-view-company.htm"></c:url>">Profil Societate</a></li>
                     <li class="nav-item"> <a class="nav-link" href="<c:url value="admin-user-list"></c:url>">Utilizatori Sistem</a></li>
...
<td>
 <a class="button badge badge-success" data-toggle="modal" data-id="${user.id}"
   ...
   <a class="button badge badge-success" 
    href="<c:url value="userlocationadmin.htm?id=${user.id}"></c:url>" >
                              <i class="fas fa-pencil-alt">
                              ListaLocatiiUser
                               </i>
                          </a>                        
