            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                ...
                <h6>Date <c:out value="${model.europeDateTime }"></c:out></h6>
                  ...
                  <a class="button badge badge-success"   title="ViewHistory"  href="admin-list-countLocation.htm?id=${getLocation.id}" id="view-source" >
                 ...
                 title="GenerateAccount"  href="admin_generate_account.htm?id=${getLocation.id}" id="view-source" >
                              <i class="fas fa-pencil-alt">
                              GenerateDecont
                               </i>
                           </a>   
                   <a class="button badge badge-success" title="ViewAccount" href="admin_view_account.htm?id=${getLocation.id}" id="view-source" >
                              <i class="fas fa-pencil-alt">
                             ViewDecont
                               </i>
                           </a>                                    
