...
%>
  ...
  <jsp:include page="/WEB-INF/superadmin/locationmodal/locationmodal.jsp" />
  <!-- endModal -->   
              ...
              <li class="nav-item">
                ...
                <div class="collapse" id="ui-basic">
                  <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item"> <a class="nav-link" href="<c:url value="home-user.htm"></c:url>">ListaLocatii</a></li>
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                ...
                <h6>Date <c:out value="${model.europeDateTime }"></c:out></h6>
                  ...
                  <a class="button badge badge-success"   title="ViewHistory"  href="list-countLocation-user.htm?id=${getLocation.id}" id="view-source" >
                              <i class="fas fa-pencil-alt">
                              View Counters
                               </i>
                           </a>     
                   <a class="button badge badge-success" title="ViewAccount" href="view_account_user.htm?id=${getLocation.id}" id="view-source" >
                              <i class="fas fa-pencil-alt">
                             ViewDecont
                               </i>
                           </a>                                   
