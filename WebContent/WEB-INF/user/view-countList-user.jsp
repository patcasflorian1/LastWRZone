            ...
            <ul class="nav">
              ...
              <li class="nav-item">
                ...
                <div class="collapse" id="auth">
                  <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="home-user.htm"> ListaLocatii</a></li>
                  </ul>
                </div>
              </li>
              <li class="nav-item">
  ...
  <div class="col-lg-12 grid-margin stretch-card">
       ...
       <div class="card-body">
                <h6>Date <c:out value="${model.europeDateTime }"></c:out></h6>
                  <h4 class="card-title"> Eveniment <code>List</code></h4>
                   ...
                   <table class="table table-hover">
                      ...
                      <c:forEach var= "loc" items="${locationList}">
                        ...
                        <td><c:out value="${loc.id}"></c:out></td>                                                   
                          <td><c:out value="${loc.locationMacAddress}"></c:out></td>
...
<td><c:out value="${loc.paymentDate}"></c:out></td>
