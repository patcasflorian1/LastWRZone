              ...
              <li class="nav-item">
                ...
                <div class="collapse" id="ui-basic">
                  <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="<c:url value="user-view-company.htm"></c:url>">Profil Societate</a></li>
...
<c:if test="${ loc.isLogin =='OnLine'}">
<td ><a class="button badge badge-success" href ="<c:url value='view-user-location.htm?id=${loc.id}'/>"><c:out value="${loc.locationName}"></c:out></a></td>
</c:if>
<c:if test="${ loc.isLogin =='OffLine'}">
<td ><a class="button badge badge-danger" href ="<c:url value='view-user-location.htm?id=${loc.id}'/>"><c:out value="${loc.locationName}"></c:out></a></td>
</c:if>
...
<td><c:out value="${loc.isLogin}"></c:out></td>
<td>Val:<c:out value="${loc.signalLevel}"></c:out><br><meter id="disk_c" value="${loc.signalLevel}" min="0" max="100">2 out of 100</meter></td>
<td>
...
<td>							                
                      ...
                      <td><c:out value="${ totalDayCount}"></c:out></td>
